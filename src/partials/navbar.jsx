          ...
          <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
            <div className="flex justify-start lg:w-0 md:flex-1">
              ...
              >
                ...
                <span className="font-extrabold tracking-wide text-gray-900 text-3xl">
                  Summify
                </span>
              </Link>
            </div>
            ...
            <Popover.Group as="nav" className="hidden space-x-10 md:flex">
              <HashLink
                to="/#2"
                className="text-lg font-medium text-gray-900 hover:text-primary transition-colors ease-in-out duration-150 umami--click--about-button-navbar"
              >
                About
              </HashLink>
              <HashLink
                to="/#3"
                className="text-lg font-medium text-gray-900 hover:text-primary transition-colors ease-in-out duration-150 umami--click--testimonials-button-navbar"
              >
                Testimonials
              </HashLink>
              <Link
                to="/pricing"
                className="text-lg font-medium text-gray-900 hover:text-primary transition-colors ease-in-out duration-150 umami--click--pricing-button-navbar"
              >
                Pricing
              </Link>
            </Popover.Group>
            <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
              <Link
                to="/signup"
                className="btn-sm ml-8 sm:px-5 px-4 text-gray-100 bg-primary hover:bg-primary-dark shrink-0 umami--click--add-to-server-button-navbar"
              >
